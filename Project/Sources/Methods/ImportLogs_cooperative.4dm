		...
		If ($file.name="@ProcessInfo@")
			...
			For each ($line; $lines)
				...
				If ($e_group=Null:C1517)
					...
					$e_group.name:=Substring:C12(String:C10($columns[7]); 2; Length:C16(String:C10($columns[7]))-2)
					$e_group.save()
				End if 
				...
				If ($e_host=Null:C1517)
					...
					$e_host.name:=Substring:C12(String:C10($columns[11]); 2; Length:C16(String:C10($columns[11]))-2)
					$e_host.save()
				End if 
				...
				If ($e_user=Null:C1517)
					...
					$e_user.name:=Substring:C12(String:C10($columns[12]); 2; Length:C16(String:C10($columns[12]))-2)
					$e_user.save()
				End if 
					...
					If ($line#"@SQL protocol@")
						...
						If ($columns.length>=6)
							...
							If ($e_component=Null:C1517)
								...
								$e_component.name:=Substring:C12(String:C10($columns[3]); 2; Length:C16(String:C10($columns[3]))-2)
								$e_component.save()
							End if 
